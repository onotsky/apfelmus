...
| Project | Contents |
|---|---|
| `Apfelmus` | The GUI itself: `MainWindow`, `StartWindow` (login), `SettingsWindow`, `OpenFolderWindow`, `RenameDownloadWindow`, splash screen |
| `ApfelmusFramework` | Core HTTP/XML communication (`WebConnect`), data models, `IValueConverter`s, theme management, config (de)serialization |
